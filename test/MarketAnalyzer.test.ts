...
describe(
  'MarketAnalyzer neutral band',
  () => {
    it(
      'returns neutral for balanced 50/50 pressure',
      () => {
        const analyzer =
          new MarketAnalyzer();
    ...
    it(
      'returns neutral for 54/46 pressure',
      () => {
        const analyzer =
          new MarketAnalyzer();
    ...
    it(
      'returns bullish with low strength for 60/40 pressure',
      () => {
        const analyzer =
          new MarketAnalyzer();
    ...
    it(
      'returns bullish with maximum strength for 100/0 pressure',
      () => {
        const analyzer =
          new MarketAnalyzer();
    ...
    it(
      'returns neutral with zero evidence when there are no whales',
      () => {
        const analyzer =
          new MarketAnalyzer();
    ...
    it(
      'returns bearish with low strength for 40/60 pressure',
      () => {
        const analyzer =
          new MarketAnalyzer();
